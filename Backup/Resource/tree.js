...
imgPlus.src="FluorineWebResource.axd?r=treenodeplus.gif&t=image/gif";
var imgMinus = new Image();
imgMinus.src="FluorineWebResource.axd?r=treenodeminus.gif&t=image/gif";
var imgDot = new Image();
imgPlus.src="FluorineWebResource.axd?r=treenodedot.gif&t=image/gif";
...
//
	...
	for(var i=0; i < el.childNodes.length; i++)
	{
		...
		else if (child.className == "treeSubnodesHidden")
		{
			...
			imgEl.src = "FluorineWebResource.axd?r=treenodeminus.gif&t=image/gif";
			break;
		}
		else if (child.className == "treeSubnodes")
		{
			child.className = "treeSubnodesHidden";
			imgEl.src = "FluorineWebResource.axd?r=treenodeplus.gif&t=image/gif";
			break;
		}
	}
}
