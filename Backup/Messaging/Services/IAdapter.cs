...
namespace com.TheSilentGroup.Fluorine.Messaging.Services
{
	...
	{
		object Invoke(IApplicationContext applicationContext, IMessage message);
		object Manage(IApplicationContext applicationContext, CommandMessage commandMessage);
		bool IsHandlingSubscribe{ get; }
