...
namespace com.TheSilentGroup.Fluorine.Messaging.Config
{
	...
	/// </summary>
	public class NetworkSettings : Hashtable
	{
		public NetworkSettings(XmlNode networkDefinitionNode)
		{
			foreach(XmlNode propertyNode in networkDefinitionNode.ChildNodes)
			{
		...
		public bool PagingEnabled
		{
			get
			{
				if( this.ContainsKey("paging_enabled")  )
					return (string)this["paging_enabled"] != "false";
				return false;
			}
		}
		...
		public int PagingSize
		{
			get
			{
				if( this.ContainsKey("paging_pageSize")  )
					return (int)this["paging_pageSize"];
				return 0;
			}
		}
