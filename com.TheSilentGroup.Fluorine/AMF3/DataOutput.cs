...
namespace com.TheSilentGroup.Fluorine.AMF3
{
	...
	class DataOutput : IDataOutput
	{
		...
		public DataOutput(IApplicationContext applicationContext, AMFWriter amfWriter)
		{
		...
		{
			_amfWriter.WriteAMF3Data(_applicationContext, value);
			//_amfWriter.WriteAMF3Null();
		}
		/// <summary>
